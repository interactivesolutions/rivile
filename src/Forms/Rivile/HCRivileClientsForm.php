...
class HCRivileClientsForm
{
            ...
            'structure' => [
                ...
                [
                    ...
                    "options" => [
                        [
                            "id" => "1",
                            "label" => "Pagal dokumentus",
                        ],
                        [
                            "id" => "2",
                            "label" => "Pagal sąskaitas",
                        ],
                    ],
                    "search" => [
                        "maximumSelectionLength" => 1,
    ...
    {
        $options = [];
        $list = N08Klij::orderBy('N08_KODAS_DS',
            'asc')->whereNotNull('N08_KODAS_DS')->select('N08_KODAS_DS')->distinct('N08_KODAS_DS')->pluck('N08_KODAS_DS');
